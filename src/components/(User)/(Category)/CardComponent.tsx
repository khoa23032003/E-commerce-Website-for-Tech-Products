...
const CardComponent = () => {
  return (
    <div className="w-full h-90 mx-auto bg-white border border-gray-200 rounded-md shadow-lg   ">
      <div className="relative">
        <a href="#">
          <img
            className="object-cover mx-auto h-60 md:h-100"
      ...
      <div className="p-5">
        ...
        <div className="border rounded-sm bg-gray-200 text-xs text-gray-500 font-medium flex flex-wrap py-1 px-1 mt-2 ">
          ...
          <span className="w-1/2 mb-1 flex">
            <BsDeviceSsdFill className="mr-1" />
            512 GB
          </span>
          <span className="flex mb-1">
            <MdMonitor className="mr-1" />
            14 inch 2.8K IPS
          </span>
        </div>
